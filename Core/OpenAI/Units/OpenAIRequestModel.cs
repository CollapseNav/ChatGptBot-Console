...
public abstract class OpenAIRequestModel
{
    protected int max_tokens1 = 2048;
    protected decimal temperature1 = 0.5m;
    protected decimal top_p1 = 0.5m;
    protected decimal frequency_penalty1 = 1;
    protected decimal presence_penalty1 = 1;
    /// <summary>
    /// 模型名称
    /// </summary>
